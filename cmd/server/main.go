// Package main provides the entry point for the AI Provider Scheduling server.
...
func main() {
	...
	log.Infof("AIProviderScheduling Version: %s, Commit: %s, BuiltAt: %s", buildinfo.Version, buildinfo.Commit, buildinfo.BuildDate)
