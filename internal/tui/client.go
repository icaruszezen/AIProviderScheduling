...
// GetAntigravityKeys fetches Antigravity API keys.
func (c *Client) GetAntigravityKeys() ([]map[string]any, error) {
	return c.getWrappedKeyList("/v0/management/antigravity-api-key", "antigravity-api-key")
}
